...
require (
	...
	github.com/jenkins-zh/jenkins-client v0.0.5-0.20211011084832-67537f72a187
...
replace (
	...
	github.com/jenkins-zh/jenkins-client => github.com/johnniang/jenkins-client v0.0.0-20211011073756-b030c2ee2749
