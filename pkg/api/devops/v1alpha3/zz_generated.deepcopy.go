...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PipelineEngineSpec) DeepCopyInto(out *PipelineEngineSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PipelineEngineSpec.
func (in *PipelineEngineSpec) DeepCopy() *PipelineEngineSpec {
	if in == nil {
		return nil
	}
	out := new(PipelineEngineSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *StepTemplateSpec) DeepCopyInto(out *StepTemplateSpec) {
	*out = *in
	...
	if in.Parameters != nil {
		in, out := &in.Parameters, &out.Parameters
		*out = make([]ParameterInStep, len(*in))
		copy(*out, *in)
	}
}
