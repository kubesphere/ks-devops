...
func Test_MultiBranchPipelineSkipNotification(t *testing.T) {
	inputs := []*devopsv1alpha3.MultiBranchPipeline{
		{
			Name:        "",
			Description: "for test",
			...
			// default is false
			// AcceptJenkinsNotification: false,
		},
		{
			Name:        "",
			Description: "for test",
		...
		},
		{
			...
			BitbucketServerSource: &devopsv1alpha3.BitbucketServerSource{
				...
				ApiUri:       "https://api.bitbucket.com",
				DiscoverPRFromForks: &devopsv1alpha3.DiscoverPRFromForks{
					Strategy: 1,
					Trust:    1,
				},
...
func Test_MultiBranchPipelineAcceptJenkinsNotification(t *testing.T) {
	inputs := []*devopsv1alpha3.MultiBranchPipeline{
		{
			Name:        "",
			Description: "for test",
			...
			GitHubSource: &devopsv1alpha3.GithubSource{
				...
				AcceptJenkinsNotification: true,
			},
		},
		{
			Name:        "",
